...
export default function AdminNav() {
  ...
  return (
    <nav className="w-[220px] min-h-screen bg-slate-900 border-r border-slate-800 flex flex-col shrink-0">
      {/* Brand */}
      ...
      <div className="border-t border-slate-800 py-3">
        <Link
          href="/base"
          className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-500 hover:text-slate-300 hover:bg-slate-800/60 transition-colors"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
