  ...
  try {
    ...
    const battleReport: BattleReport = {
      ...
      attacker: {
        ...
        hero_bonus_attack: clampBonus(attHero.totalAttackBonus),
        race_bonus_attack: getAttackerRaceBonus(attPlayer.race),
        tribe_mult_attack: attTribeCombatMult,
      ...
      defender: {
        ...
        hero_bonus_defense: clampBonus(defHero.totalDefenseBonus),
        race_bonus_defense: getDefenderRaceBonus(defPlayer.race),
        tribe_mult_defense: defTribeCombatMult,
