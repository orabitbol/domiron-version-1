  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="p-2.5 rounded-game-lg bg-game-elevated border border-game-border animate-[spin_12s_linear_infinite]">
          <Settings className="size-5 text-game-text-secondary" />
        </div>
        <div>
          <h1 className="font-display text-game-2xl gold-gradient-text-static uppercase tracking-wide">⚙️ הגדרות</h1>
      ...
      {activeTab === 'profile' && (
        <div className="space-y-4">
          <div className="card-game p-5 space-y-4">
            <h2 className="font-heading text-game-sm uppercase tracking-wider text-game-text">פרטי פרופיל</h2>
            <div>
              <Input
                label="שם תצוגה"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-3 border-t border-game-border">
              {[
      ...
      {activeTab === 'game' && (
        <div className="card-game p-5 space-y-4">
          <h2 className="font-heading text-game-sm uppercase tracking-wider text-game-text">הגדרות משחק</h2>
          {[
            ...
            <div key={label} className="flex items-center justify-between py-3 border-b border-game-border last:border-0">
              <div>
      ...
      {activeTab === 'account' && (
        <div className="space-y-4">
          <div className="card-game p-5 space-y-3">
            <h2 className="font-heading text-game-sm uppercase tracking-wider text-game-text">פרטי חשבון</h2>
          ...
          <div className="p-4 rounded-game-xl bg-game-red/10 border border-game-red/30 space-y-3">
